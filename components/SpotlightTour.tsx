...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    kicker: 'ADAPTIVE FEEDBACK',
    stepNumber: 2,
    totalSpotlightSteps: 5,
    headline: 'Daily Check-in & Readiness',
    description:
      "Tell us how you're feeling each day — this is what makes your movement plan adapt in real time to your energy and joints.",
    buttonText: 'Next',
    tooltipPosition: 'bottom',
  },
  {
